...
public fun <V : View> View.bindView(id: Int)
    : ReadOnlyProperty<View, V> = ViewBinding(id, ::findView)
public fun <V : View> Activity.bindView(id: Int)
    : ReadOnlyProperty<Activity, V> = ViewBinding(id, ::findView)
public fun <V : View> Dialog.bindView(id: Int)
    : ReadOnlyProperty<Dialog, V> = ViewBinding(id, ::findView)
...
public fun <V : View> View.bindOptionalView(id: Int)
    : ReadOnlyProperty<View, V?> = OptionalViewBinding(id, ::findView)
public fun <V : View> Activity.bindOptionalView(id: Int)
    : ReadOnlyProperty<Activity, V?> = OptionalViewBinding(id, ::findView)
public fun <V : View> Dialog.bindOptionalView(id: Int)
    : ReadOnlyProperty<Dialog, V?> = OptionalViewBinding(id, ::findView)
...
public fun <V : View> View.bindViews(vararg ids: Int)
    : ReadOnlyProperty<View, List<V>> = ViewListBinding(ids, ::findView)
public fun <V : View> Activity.bindViews(vararg ids: Int)
    : ReadOnlyProperty<Activity, List<V>> = ViewListBinding(ids, ::findView)
public fun <V : View> Dialog.bindViews(vararg ids: Int)
    : ReadOnlyProperty<Dialog, List<V>> = ViewListBinding(ids, ::findView)
...
public fun <V : View> View.bindOptionalViews(vararg ids: Int)
    : ReadOnlyProperty<View, List<V>> = OptionalViewListBinding(ids, ::findView)
public fun <V : View> Activity.bindOptionalViews(vararg ids: Int)
    : ReadOnlyProperty<Activity, List<V>> = OptionalViewListBinding(ids, ::findView)
public fun <V : View> Dialog.bindOptionalViews(vararg ids: Int)
    : ReadOnlyProperty<Dialog, List<V>> = OptionalViewListBinding(ids, ::findView)
